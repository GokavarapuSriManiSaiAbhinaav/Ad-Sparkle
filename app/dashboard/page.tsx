                ...
                <div className="max-w-6xl mx-auto px-6 md:px-8 py-4 flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium text-muted-foreground leading-none mt-0.5">
                                Group Management
                            </p>
                        </div>
                    </div>
            ...
            <div className="max-w-6xl mx-auto px-6 md:px-8 py-10 relative z-10">
                ...
                {!loading && !error && groups.length === 0 && (
                    <motion.div
                        initial={{ opacity: 0, y: 8 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="rounded-3xl border border-dashed border-border bg-card/50 shadow-sm py-20 flex flex-col items-center gap-4 text-center"
                    >
                        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-muted/50 shadow-sm border border-border">
                            <Users className="h-8 w-8 text-muted-foreground" />
                        </div>
                        <div>
                            <p className="font-semibold text-lg text-foreground">No groups yet</p>
                                    ...
                                    >
                                        <div className="bg-card rounded-2xl shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 border border-border h-full flex flex-col overflow-hidden relative">
                                            ...
                                            <div className="p-6 flex items-start gap-4 flex-1">
                                                {/* Avatar */}
                                                <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-2xl text-white font-bold text-lg shadow-md border border-border/50"
                                            ...
                                            <div className="mt-auto border-t border-border p-4 px-6 flex justify-between items-center bg-muted/30 group-hover:bg-card transition-colors">
                                                <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest group-hover:text-foreground transition-colors">Manage group</span>
